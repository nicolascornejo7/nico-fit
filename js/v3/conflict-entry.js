...
if(isV3ConflictsEnabled()){
  ...
  button.onclick=async()=>{
    if(opening)return;if(!userId||!isV3ConflictsEnabled()||!isV3LocalStorageEnabled()){window.alert('Iniciá sesión y habilitá explícitamente almacenamiento local y conflictos V3.');return;}
