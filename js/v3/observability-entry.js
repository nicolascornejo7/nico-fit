...
if(isV3ObservabilityEnabled()){
  ...
  button.onclick=async()=>{
    if(opening)return;if(!userId||!isV3ObservabilityEnabled()||!isV3LocalStorageEnabled()){window.alert('Iniciá sesión y habilitá explícitamente almacenamiento local y observabilidad V3.');return;}
