...
export const INTERNAL_STORES={operations:'pending_operations',migrations:'migration_map'};
...
export function openUserDatabase({userId,indexedDB=globalThis.indexedDB}={}){
