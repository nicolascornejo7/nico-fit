const CACHE_NAME='nico-fit-v6';
const APP_ASSETS=['./','./index.html','./styles.css','./manifest.json','./js/app.js','./js/plan.js','./js/store.js','./js/sync.js','./js/charts.js','./js/active-session.js','./icons/icon-192.png','./icons/icon-512.png'];
