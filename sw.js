...
const APP_ASSETS=[
  ...
  './js/v3/feature-flags.js','./js/v3/import-v2-routines.js','./js/v3/import-v2-signals.js',
  ...
  './js/v3/sync-engine.js','./js/v3/sync-lock.js','./js/v3/sync-protocol.js',
...
self.addEventListener('fetch',event=>{
  ...
  event.respondWith((async()=>{
    ...
    if(request.mode!=='navigate'&&event.clientId){
      ...
      const build=(await askClient(client,'NICO_FIT_BUILD_QUERY',600))?.buildId;
